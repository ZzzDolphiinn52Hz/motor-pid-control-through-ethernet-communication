...
Firmware được tổ chức theo mô hình đa nhiệm của FreeRTOS. Trong đó, các chức năng chính như đo tốc độ, điều khiển động cơ và truyền thông TCP/IP được tách thành các khối xử lý riêng. Việc chia chương trình thành nhiều khối giúp hệ thống hoạt động ổn định, dễ mở rộng và thuận tiện cho quá trình kiểm tra, sửa lỗi.

Cấu trúc firmware gồm các khối chức năng chính: khối khởi tạo phần cứng, khối đọc encoder, khối điều khiển PWM cho động cơ, khối điều khiển PI, khối truyền thông Ethernet TCP/IP, khối xử lý frame dữ liệu và khối phản hồi dữ liệu về máy tính.
